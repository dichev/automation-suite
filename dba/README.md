...
* **[fetch](#fetch)**
    ...
    * **[schema-diff](#fetch-schema-diff)** - compare database schemas of the operators
...
* **[migrations](#migrations)**
    ...
    * **[update-users-game-config-id](#migrations-update-users-game-config-id2)** 
* **[utils](#utils)**
...
```
### <a name="fetch-schema-diff"></a>schema-diff
Compare database schemas of the operators
```
Usage: node dba/fetch/schema-diff --operators <name> 
