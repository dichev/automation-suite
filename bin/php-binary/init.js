...
deployer
    ...
    .run(async (host) => {
		...
		await ssh.exec('apt-get update && apt-get install libxslt1.1 libreadline7 -y')
        ...
        await ssh.exec('rm -fv /lib/systemd/system/php*-fpm.service && systemctl enable /opt/servers-conf/php/php-fpm.service')
