...
/**
 * Usage:
 * $ node bin/cdn/check --hosts dev-hermes-lb --blue --revision r4.8.233
 */
...
program
    ...
    .run(async (host) => {
        ...
        if (!MODE) throw Error('Missing required parameters: --mode --revision') // TODO: support required option
