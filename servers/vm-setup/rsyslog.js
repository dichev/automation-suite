...
program
    ...
    .iterate('hosts', async (host) => {
        ...
        await ssh.exec('echo \'deb http://download.opensuse.org/repositories/home:/rgerhards/Debian_9.0/ /\' > /etc/apt/sources.list.d/home:rgerhards.list')
        await ssh.exec('wget -nv http://download.opensuse.org/repositories/home:/rgerhards/Debian_9.0/Release.key -O - | apt-key add -')
