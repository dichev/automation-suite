...
.option('-n, --networks <list|all>', 'Networks', {required: true})
...
.iterate('hosts', async (host) => {
    ...
    // TODO: This will print that's executing on host, but it's NOT. Can it be fixed in someway
    // Execute only if the host network is included
    if (networks.includes(hostNetwork)) { // TODO: има ли начин тук да кажа continue, вместо да ограждам целият код със скоби
